...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net mr_buffer_et_0_m00_axis [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins mr_buffer_et_0/m00_axis]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins axis_signal_gen_v4_c_0/s_axi] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins axis_signal_gen_v6_0/s_axi] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins mr_buffer_et_0/s00_axi] [get_bd_intf_pins ps8_0_axi_periph/M04_AXI]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_signal_gen_v4_c_0/s_axi_aresetn] [get_bd_pins axis_signal_gen_v6_0/s0_axis_aresetn] [get_bd_pins axis_signal_gen_v6_0/s_axi_aresetn] [get_bd_pins mr_buffer_et_0/m00_axis_aresetn] [get_bd_pins mr_buffer_et_0/s00_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_100/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins mr_buffer_et_0/trigger] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_signal_gen_v4_c_0/s_axi_aclk] [get_bd_pins axis_signal_gen_v6_0/s0_axis_aclk] [get_bd_pins axis_signal_gen_v6_0/s_axi_aclk] [get_bd_pins mr_buffer_et_0/m00_axis_aclk] [get_bd_pins mr_buffer_et_0/s00_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_100/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins rst_100/ext_reset_in] [get_bd_pins rst_adc0/ext_reset_in] [get_bd_pins rst_adc0_x2/ext_reset_in] [get_bd_pins rst_dac0/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_signal_gen_v6_0/s_axi/reg0] -force
  assign_bd_address -offset 0xA0070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mr_buffer_et_0/s00_axi/reg0] -force
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.29717",
   "Default View_TopLeft":"-1003,-1659",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port adc0_clk -pg 1 -lvl 0 -x -290 -y 220 -defaultsOSRD
preplace port dac0_clk -pg 1 -lvl 0 -x -290 -y 240 -defaultsOSRD
preplace port vin0_01 -pg 1 -lvl 0 -x -290 -y 260 -defaultsOSRD
preplace port sysref_in -pg 1 -lvl 0 -x -290 -y 280 -defaultsOSRD
preplace port vout00 -pg 1 -lvl 6 -x 2310 -y 270 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 3 -x 790 -y -1530 -defaultsOSRD
preplace inst usp_rf_data_converter_0 -pg 1 -lvl 3 -x 790 -y 290 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 4 -x 1390 -y -1340 -defaultsOSRD
preplace inst rst_100 -pg 1 -lvl 3 -x 790 -y -1240 -defaultsOSRD
preplace inst axis_signal_gen_v6_0 -pg 1 -lvl 2 -x 190 -y -110 -defaultsOSRD
preplace inst clk_adc0_x2 -pg 1 -lvl 3 -x 790 -y -800 -defaultsOSRD
preplace inst rst_adc0 -pg 1 -lvl 3 -x 790 -y -1000 -defaultsOSRD -resize 320 156
preplace inst rst_adc0_x2 -pg 1 -lvl 3 -x 790 -y -640 -defaultsOSRD -resize 320 156
preplace inst rst_dac0 -pg 1 -lvl 3 -x 790 -y -420 -defaultsOSRD -resize 320 156
preplace inst axis_signal_gen_v4_c_0 -pg 1 -lvl 1 -x -110 -y -110 -defaultsOSRD
preplace inst mr_buffer_et_0 -pg 1 -lvl 4 -x 1390 -y -80 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 5 -x 1770 -y -90 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 190 -y -1510 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 3 -x 790 -y -120 -defaultsOSRD
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 5 -250 -210 40 -1430 370 -1440 1190 -220 1550
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 2 2 390 -1410 1150
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 0 5 -270 -220 30 60 330 60 1210J 60 1560
preplace netloc usp_rf_data_converter_0_clk_adc0 1 2 2 410 -1100 1160
preplace netloc rst_adc0_peripheral_aresetn 1 2 2 420 -900 1150
preplace netloc clk_adc0_x2_locked 1 2 2 430 -870 1150
preplace netloc clk_adc0_x2_clk_out1 1 2 2 400 -880 1180
preplace netloc usp_rf_data_converter_0_clk_dac0 1 0 4 -250 0 40 30 360 120 1150
preplace netloc rst_dac0_peripheral_aresetn 1 0 4 -260 -10 50 50 340J 50 1150
preplace netloc rst_adc0_x2_peripheral_aresetn 1 2 2 430 -40 1170
preplace netloc xlconstant_0_dout 1 3 1 N -120
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 3 1 1210J -1560n
preplace netloc ps8_0_axi_periph_M00_AXI 1 2 3 380 -1640 NJ -1640 1570
preplace netloc axis_signal_gen_v6_0_m_axis 1 2 1 350 -110n
preplace netloc axis_signal_gen_v4_c_0_m_axis 1 1 1 20 -170n
preplace netloc adc0_clk_1 1 0 3 N 220 NJ 220 NJ
preplace netloc dac0_clk_1 1 0 3 NJ 240 NJ 240 N
preplace netloc vin0_01_1 1 0 3 NJ 260 NJ 260 N
preplace netloc sysref_in_1 1 0 3 NJ 280 NJ 280 N
preplace netloc usp_rf_data_converter_0_vout00 1 3 3 NJ 270 N 270 N
preplace netloc usp_rf_data_converter_0_m00_axis 1 3 1 1200 -160n
preplace netloc mr_buffer_et_0_m00_axis 1 4 1 1570 -110n
preplace netloc ps8_0_axi_periph_M01_AXI 1 4 1 1570 -1360n
preplace netloc ps8_0_axi_periph_M02_AXI 1 0 5 -260 -1630 NJ -1630 NJ -1630 NJ -1630 1560J
preplace netloc ps8_0_axi_periph_M03_AXI 1 1 4 50 -1620 NJ -1620 NJ -1620 1550J
preplace netloc ps8_0_axi_periph_M04_AXI 1 3 2 1220 -1540 1540J
preplace netloc axi_dma_0_M_AXI_S2MM 1 1 5 20 -1650 N -1650 N -1650 N -1650 1950
preplace netloc axi_smc_M00_AXI 1 2 1 360 -1560n
levelinfo -pg 1 -290 -110 190 790 1390 1770 2310
pagesize -pg 1 -db -bbox -sgen -410 -1680 2410 460
"
}
